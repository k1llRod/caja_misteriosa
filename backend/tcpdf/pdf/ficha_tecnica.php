...
require_once '../../controlador/activo.php';
...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->Cell(60, 15, 'Resivo de activos fijos', 0, 1, 'C', 0, 0, 0, 0, 'T', 'C');

        $this->SetFont('helvetica', 'C', 7);
        $this->Cell(45, 3, 'ACTIVOS FIJOS', 0, 1, 'C', 0, 0, 0, 0, 'T', 'T');
...
if($_GET["opcion"] == "on"){
$pdf->Cell(45, 3, 'ACTIVO', 0, 1, 'C', 0, 0, 0, 0, 'T', 'T');
}
$html1 = <<<EOF
